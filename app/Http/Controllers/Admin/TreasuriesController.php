...
class TreasuriesController extends Controller
{
    public function index(){
        ...
        $data=Treasuries::select()->where('com_code', '=', $com_code)->paginate(PAGINATION_COUNT);
    ...
    public function update($id,TreasuriesRequest $request){
        ...
        try{
            ...
            $data=Treasuries::select()->find($id);
            if(empty($data)){
                return redirect()->route('admin.treasuries.create')->with(['error' => 'عفوا   غير قادر علي الوصول للبيانات المطلوبة' ]);
    ...
    return redirect()->route('admin.treasuries.create')->with(['success' => ' لقد تم تحديث البيانات بنجاح ' ]);
    ...
    public function ajax_search(Request $request){
        ...
        $data=Treasuries::where('name','LIKE',"%{$search_by_text}%")->where('com_code', '=', $com_code)->paginate(PAGINATION_COUNT);
        ...
        public function details($id){
            try{
                ...
                $data=Treasuries::select()->find($id);
                if(empty($data)){
                    return redirect()->route('admin.treasuries.index')->with(['error' => 'عفوا   غير قادر علي الوصول للبيانات المطلوبة' ]);
