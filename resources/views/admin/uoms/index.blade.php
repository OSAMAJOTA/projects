...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title card_title_center">بيانات   الوحدات الاصناف</h3>
        ...
        <div id="ajax_responce_serarchDiv">
         ...
         @foreach ($data as $info )
            <tr>
             <td>{{ $i }}</td>  
             <td>{{ $info->name }}</td>  
             <td>@if($info->is_master==1) وحدة اب @else وحدة تجزئة @endif</td> 
  ...
  @if($info->updated_by>0 and $info->updated_by!=null )
        ...
        <a href="{{ route('admin.uoms.delete',$info->id) }}" class="btn btn-sm are_you_shue btn-danger">حزف</a> 
